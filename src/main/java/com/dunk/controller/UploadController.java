...
import com.dunk.domain.AttachFileDTO;
...
public class UploadController {
	...
	private boolean checkImageType(File file) { //들어오는 파일이 이미지인지 확인한다.
	...
	//@PreAuthorize("isAuthenticated()") //로그인한 사용자만 업로드할 수 있다.
	...
	@ResponseBody
	public ResponseEntity<String> deleteFie(String fileName, String type) {
